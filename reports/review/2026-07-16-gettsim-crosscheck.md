...
Beide von juliuswiener am 2026-07-09 eroeffnet, unveraendert offen. GETTSIM 1.2.1 traegt beide Bugs weiter. In diesem Lauf zeigen sich 7 Splitting-Abweichungen (#1209) und 0 Grundtarif-Abweichungen (#1210) — GETTSIM-Signatur, kein Catala-Fehler.


## Coverage (alle 93 Golden-Faelle)
...
| g32a (§ 32a-Tarif) | 44 | JA (44) | § 32a-Tarif direkt vs GETTSIM einkommensteuer.betrag |
| gesamt (festzusetzende ESt) | 11 | NEIN (verschoben) | volle festzusetzende ESt: § 31-Guenstigerpruefung/§ 35a/§ 24a/Vorsorge-Deckel; Node-Mapping nicht 1:1, separater Harness noetig — NICHT forciert (falsche Deltas vermeiden) |
...
Deckungsfaehig und verglichen: **44** § 32a-Tarif-Faelle. Nicht deckungsfaehige Domaenen sind oben ausgewiesen (kein stiller Ausschluss); ihre Verifikation laeuft ueber den eigenen Golden-Gate (value + Zitatanker) bzw. — fuer gesamt — einen kuenftigen festzusetzende-ESt-Harness (Backlog).


## § 32a-Tarif-Cross-Check: 44 Faelle, 37 deckungsgleich, 7 Abweichungen
