...
def _init_gesamt(base, fall_id="pf"):
    ...
    for ev in [
        ...
        _laie("versicherungsart", "gesetzlich_an"), _laie("vorsorge_arbeitslosenversicherung", 0), _laie("vorsorge_erwerbsunfaehigkeit", 0), _laie("vorsorge_unfall_haftpflicht", 0), _laie("vorsorge_rv_alt_mit_ueberschuss", 0), _laie("vorsorge_rv_alt_ohne_ueberschuss", 0), _laie("mit_anspruch_auf_zuschuss", False),
...
class TestPreflightEmpty:
    ...
    def test_unbekannter_fall_404(self, base):
        st, _ = _req(base, "GET", "/fall/nixda/preflight", erwarte=404)
