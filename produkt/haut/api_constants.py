...
KV_PV_FELDER = ("basis_kv", "basis_pv", "weitere_vorsorgeaufwendungen", "mit_anspruch_auf_zuschuss")
KV_PV_PARTNER_FELDER = ("basis_kv_partner", "basis_pv_partner", "weitere_vorsorgeaufwendungen_partner",
