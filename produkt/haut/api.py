...
def _bescheid_fn(quantitaet: str, vz: int, bindung: dict, felder: dict | None = None,
    ...
    # §33b Abs.5 Kind-PB: _kind_behinderten_pb_daten(store, bindung, nur_bestaetigt) steht seit
    # dem Refactor auf Modulebene.
    ...
    # §35a/§35c + Sonderausgaben + agB: _shared_steuer_sonder_agb(...) steht seit dem
    # Refactor auf Modulebene.

    # §33a/§10d_2 + §34c: _shared_dba_sonstige(...) steht seit dem Refactor auf Modulebene.
